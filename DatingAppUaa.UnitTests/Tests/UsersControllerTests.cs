...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class UsersControllerTests
    {
        ...
        public async Task getUsersNoPaginationOKFn(string statusCode, string username, string password)
        {
            // Arrange
        ...
        public async Task getUsersWithPaginationOKFn(string statusCode, string username, string password, int pageSize, int pageNumber)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
        ...
        public async Task getUserByUsernameOKFn(string statusCode, string username, string password)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        public async Task updateUserNoContentFn(string statusCode, string username, string password,string introduction,string lookingFor,string interests, string city,string country)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        public async Task addPhotoCreatedFn(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        public async Task setMainPhotoOKFn(string statusCode, string username, string password, string file)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
        ...
        public async Task deletePhotoOKFn(string statusCode, string username, string password,string file)
        {
            // Arrange
            var user = await LoginHelper.LoginUser(username, password);
            _client.DefaultRequestHeaders.Authorization = new AuthenticationHeaderValue("Bearer", user.Token);
        ...
        public async Task deletePhotoNotFoundFn(string statusCode, string username, string password, string id)
        {
            // Arrange
            _client.DefaultRequestHeaders.Authorization = null;
            var user = await LoginHelper.LoginUser(username, password);
