...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class AccountControllerTests
    {
        ...
        public async Task registerFailFn(string statusCode, string username, string knownAs, string gender, DateTime dateOfBirth, string city, string country, string password)
        {
            // Arrange
        ...
        public async Task registerReturnOkFn(string statusCode, string username, string knownAs, string gender, DateTime dateOfBirth, string city, string country, string password)
        {
            // Arrange
            requestUri = $"{apiRoute}/register";
            var registerDto = new RegisterDto
        ...
        public async Task loginFailFn(string statusCode, string username, string password)
        {
            // Arrange
        ...
        public async Task loginReturnOKFn(string statusCode, string username, string password)
        {
            // Arrange
            requestUri = $"{apiRoute}/login";
            var loginDto = new LoginDto
