...
namespace DatingAppUaa.UnitTests.Pruebas
{
    public class BuggyControllerTests
    {
        ...
        public async Task getSecretOKFn(string statusCode, string username, string password)
        {
            // Arrange
        ...
        [Theory]
        [InlineData("NotFound")]
        public async Task getNotFoundNotFoundFn(string statusCode)
        {
            // Arrange
        ...
        public async Task getServerErrorServerErrorFn(string statusCode)
        {
            // Arrange
        ...
        public async Task getBadRequestBadRequestFn(string statusCode)
        {
            // Arrange
